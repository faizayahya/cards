...
"""
  ...
  def create_deck(hand_size) do
    Cards.create_deck
    |> Cards.shuffle #automatically passes create deck to shuffle and produce a new deck
    |> Cards.deal(hand_size) #return value from new deck will be passed on as the first argument
  end
end
